  ...
  return (
    <div className="h-screen bg-gradient-to-b from-stone-50 to-stone-100 flex flex-col items-center justify-center p-8 overflow-hidden">
      <div className="w-full max-w-5xl p-6 mb-6 text-center">
        <h1 className="text-5xl font-bold text-gray-900 mb-3">효소방 키오스크</h1>
      ...
      <div className="w-full max-w-5xl bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg p-8 mb-6 text-center border border-stone-200">
        <p className="text-3xl text-gray-800 mb-2 leading-relaxed">효소방 이용을 위해 화면을 터치하거나</p>
        <p className="text-3xl text-gray-800 leading-relaxed">회원 번호를 입력해 주세요.</p>
      </div>
      ...
      <div className="w-full max-w-5xl bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg p-8 flex gap-8 mb-6 border border-stone-200">
        ...
        >
          ...
          <span>QR 코드 스캔</span>
          <span className="text-xl text-gray-600 font-normal">(카메라 아이콘)</span>
        </button>
        ...
        >
          <span className="text-6xl">🔢</span>
          <span>전화번호 입력</span>
          <span className="text-xl text-emerald-50 font-normal">(키패드 아이콘)</span>
        </button>
      </div>
      ...
      <div onClick={handleAdminClick} className="mt-6 h-12 w-full cursor-pointer" style={{ userSelect: "none" }} />
    </div>
  )
}
